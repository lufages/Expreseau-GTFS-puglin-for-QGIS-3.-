...
SOURCES = \
	__init__.py \
	ExpreseauGTFS.py ExpreseauGTFS_dockwidget.py

PLUGINNAME = ExpreseauGTFS

PY_FILES = \
	__init__.py \
	ExpreseauGTFS.py ExpreseauGTFS_dockwidget.py

UI_FILES = ExpreseauGTFS_dockwidget_base.ui
...
QGISDIR=C:\Users\Lucas\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
